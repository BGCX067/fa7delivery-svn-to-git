...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="listTra" action="listTra"><g:message code="Pedidos em Trânsito" args="[entityName]" /></g:link></span>
            <span class="menuButton"><g:link class="listCan" action="listCan"><g:message code="Pedidos Cancelados" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
            <h1><g:message code="Pedidos em Execução" args="[entityName]" /></h1>
