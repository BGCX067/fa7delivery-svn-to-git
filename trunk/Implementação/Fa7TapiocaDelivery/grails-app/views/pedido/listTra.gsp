...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="listFin" action="listFin"><g:message code="Pedidos Finalizados" args="[entityName]" /></g:link></span>
            <span class="menuButton"><g:link class="listCan" action="listCan"><g:message code="Pedidos Cancelados" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
            <h1><g:message code="Pedidos em Trânsito" args="[entityName]" /></h1>
