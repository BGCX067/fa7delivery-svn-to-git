            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="funcionario.senha.label" default="Senha" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: funcionarioInstance, field: "senha")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="funcionario.cargo.label" default="Cargo" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: funcionarioInstance, field: "cargo")}</td>
