            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="endereco.pontoDeReferenica.label" default="Ponto De Referenica" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: enderecoInstance, field: "pontoDeReferenica")}</td>
